...
namespace Sistema
{
    public static class Manager
    {
        ...
        public static void SendDB(string horario, string materia, string professor, string sala,string data,string cardp)
        {
            ...
            string URI = Url.url+"/Servicesphp.php?servID=33";
        ...
        {
            ServicePointManager.Expect100Continue = false;
            string URI = Url.url+"/Servicesphp.php?servID=36";
            NameValueCollection nv = new NameValueCollection();
            nv.Add("horario", horario);         
            using (WebClient wc = new WebClient())
            {
        ...
        public static string getDb2()
        {
            ...
            try
            {
                result = client.DownloadString(Url.url+"/Servicesphp.php?servID=19");
                return result;
            }
            catch
            {
        ...
        public static string getcardapio()
        {
            ...
            try
            {
                result = client.DownloadString(Url.url+"/cardap.txt");
                return result;
            }
            catch
            {
        ...
        public static string getdatefromdb()
        {
            ...
            try
            {
                ...
                result = client.DownloadString(Url.url+"/Servicesphp.php?servID=12");
